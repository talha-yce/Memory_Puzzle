...
def main():
    ...
    while True: 
        ...
        elapsed_time = (pygame.time.get_ticks() - start_time) // 1000  # Geçen süreyi saniye cinsinden hesapla
        minutes = elapsed_time // 60  # Dakikaları hesapla
        seconds = elapsed_time % 60  # Saniyeleri hesapla
        time_text = font.render(f"Geçen Süre: {minutes:02d}:{seconds:02d}", True, (255, 255, 255))
        ekran.blit(time_text, (200, 10))            
        ...
        uyari_metni = font.render("Puan BİTTİ!", True, kirmizi)
